...
/**
 * An equivalent of [com.badlogic.gdx.Game] delegating game events to a [Screen]. On contrary to `Game`, [ForkedKtxGame]
 ...
 * @see KtxScreen
 */
open class ForkedKtxGame<ScreenType : Screen>(
        firstScreen: ScreenType? = null,
        fixedTimeStep: Float = 1f / 60f,
        maxDeltaTime: Float = 1f,
        useFixedStep: Boolean = true) : ForkedKotlinApplication(fixedTimeStep, maxDeltaTime, useFixedStep) {
